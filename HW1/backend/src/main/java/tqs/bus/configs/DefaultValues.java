...
public class DefaultValues implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        trip1.setPrice(10.0);
        trip1.setDepartureDay("2021-03-01");
        ...
        trip2.setDepartureDay("2021-03-01");
        trip2.setDepartureHour("15:00");
        ...
        trip3.setPrice(12.0);
        trip3.setDepartureDay("2021-03-02");
        trip3.setDepartureHour("09:00");
        ...
        trip4.setDepartureDay("2021-03-02");
        trip4.setDepartureHour("14:00");

        ArrayList<Seat> seatsBus4 = new ArrayList<Seat>(bus4.getSeats());
        ...
        for (int tripNumber = 5; tripNumber <= 10; tripNumber++) {
            ...
            trip.setDepartureDay("2021-03-" + (tripNumber + 1)); // Adjust date accordingly
            trip.setDepartureHour("10:00");

            ArrayList<Seat> seats = new ArrayList<Seat>(bus5.getSeats());
            for (int i = 0; i < bus5.getSeats(); i++) {
